...
public interface FriendMvpPresenter <V extends FriendMvpView> extends MvpPresenter<V> {
    ...
    void onUpdateData(long id,String firstName, String lastName, String gender, String Age, String Address);
    void onDeleteData(long id,String firstName, String lastName, String gender, String Age, String Address);
}
