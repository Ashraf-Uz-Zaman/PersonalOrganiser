...
public class ToDoNotCompleteAdapter extends RecyclerView.Adapter<ToDoNotCompleteAdapter.ViewHolder> {


    private Context context;
    private List<ToDoNotCompleteModel> list;

    public ToDoNotCompleteAdapter(Context context, List<ToDoNotCompleteModel> list) {
    ...
    public void setData(List<ToDoNotCompleteModel> list) {
        this.list = list;
